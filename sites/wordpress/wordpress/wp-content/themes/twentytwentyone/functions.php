...
add_action( 'wp_enqueue_scripts', 'query_pagination_render_more_query' );

function my_theme_scripts() {
    wp_enqueue_script( 'my-great-script', get_template_directory_uri() . '/assets/js/jquery-3.6.0.min.js', array( 'jquery' ), '3.6.0', true );
}
